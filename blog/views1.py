...
class User(object):
    def __init__(self,qyname,sbh,name,qytype,qyaddress,phoneg,phoney,fptype,sstype,skp,bsp,qtime,ztime,yinhang,zhanghao):
        self.qyname = qyname
        self.sbh = sbh
        self.name = name
        self.qytype = qytype
...
def user(requeset1):
    ...
    # 面向对象地址
    date_url1 = 'http://114.55.106.114/server/crm/public/jsp/khtab/khjbxx.jsp?qxxkdm=1406&pageSize=200&KHBH=1709040937350001'
    date_url2 = 'http://114.55.106.114/server/crm/public/jsp/khtab/sbxx.jsp?qxxkdm=1406&pageSize=200&KHBH=1709150921480001'
    date_url3 = 'http://114.55.106.114/server/crm/public/jsp/khtab/fwht.jsp?qxxkdm=1406&pageSize=200&KHBH=1709130956059001'
    Date_Data = {}
  ...
  #  user = User(qyname, sbh, name, qytype, qyaddress, phoneg, phoney, fptype, sstype, skp, bsp, qtime, ztime,yinhang,zhanghao)
    c = {"user": user}
